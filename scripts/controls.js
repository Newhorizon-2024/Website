...
const playlist = [
    ...
    { path: 'media/Falling Apart - Daniel Pemberton.mp3', description: `电影《蜘蛛侠：纵横宇宙》"Spider-Man:Across The Spider-Verse"` },
    ...
    { path: 'media/阿七 - 发条月亮.mp3', description: `动画《刺客五六七》` },
    ...
    { path: 'media/Catastrophes before the calamity - DM DOKURO.mp3', description: `游戏《泰拉瑞亚》"Terraria" Calamity Mod` },
    { path: 'media/In Full Swing (游戏内录) - John Paesano.mp3', description: `游戏《漫威蜘蛛侠2》"Marvel Spider-Man 2"` },
    ...
    { path: 'media/Spider-Man (From Marvels Spider-Man Score) - John Paesano.mp3', description: `游戏《漫威蜘蛛侠》"Marvel Spider-Man"` },
    { path: 'media/Stained, Brutal Calamity - DM DOKURO.mp3', description: `游戏《泰拉瑞亚》"Terraria" Calamity Mod` },
